...
class MeditationPage extends StatefulWidget {
  ...
  const MeditationPage({super.key, this.onComplete});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Meditation', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
      body: _isLoading
          ...
          : Column(
              ...
              children: [
                Lottie.asset('assets/animations/medi.json', width: 200, height: 200, repeat: true),
                const SizedBox(height: 24),
                Text(
                  _isPlaying ? 'Playing Meditation...' : 'Paused',
                ...
                ElevatedButton(
                  ...
                  child: const Text('End Meditation Session', style: TextStyle(fontWeight: FontWeight.bold)),
                ),
              ],
            ),
    );
